...
//        public void SetValue(int wood, int iron, int soil)
//        {
//            Wood = wood;
//            Iron = iron;
//            Soil = soil;
...
//            ItemList[] weaponLevel = new ItemList[3];
//            weaponLevel[1].SetValue(3, 5, 5);
...
//            {
//                tempItemCounts[(int)ItemType.Wood],
...
//        void SetColor(int PlayerItem, int NecessaryItemLevel, int ItemID)
//        {
//            if (ItemID == 0)
//            {
//                if (playerItem[PlayerItem] < weaponNecessaryItem[NecessaryItemLevel, PlayerItem])
//                {
